  ...
  const handleDownloadPDF = () => {
    ...
    if (input) {
      html2canvas(input, { scale: 2 }).then((canvas) => {
        ...
        pdf.save(`surat-domisili-${formData.nama || 'warga'}.pdf`);
      });
    }
  };
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
      <div className="bg-gray-800 p-8 rounded-xl">
        <h3 className="text-2xl font-semibold text-white mb-6">Formulir Surat Keterangan Domisili</h3>
      ...
      <div>
        ...
        <div id="surat-preview" ref={suratRef} className="bg-white text-gray-900 p-8 rounded-md shadow-lg">
          ...
          <div className="text-center mb-8">
            <p className="font-bold underline uppercase">Surat Keterangan Domisili</p>
            <p>Nomor: 474 / SKD / DS / {new Date().getMonth() + 1} / {new Date().getFullYear()}</p>
          </div>
          <div className="text-justify space-y-4">
            ...
            <p>Adalah benar merupakan warga yang berdomisili di:</p>
            <p className="font-bold text-center my-4">"{formData.alamat || '...'}"</p>
